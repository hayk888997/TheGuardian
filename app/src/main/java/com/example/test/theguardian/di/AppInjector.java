...
public class AppInjector {
    ...
    public static void init(TheGuardianApplication theGuardianApplication) {
        DaggerAppComponent.builder().application(theGuardianApplication)
                .build().inject(theGuardianApplication);

        theGuardianApplication
